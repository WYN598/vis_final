...
def computeRSI(data, time_window):
    ...
    rs = abs(up_chg_avg / down_chg_avg.replace(0, 1))  # 避免除零错误
    rsi = 100 - 100 / (1 + rs)
    return rsi
...
fig.update_layout(
    ...
    updatemenus=[
        ...
        dict(
            ...
            buttons=[
                ...
                #     method="update",
                #     args=[{"template": "plotly_grey"}],
                #     args2=[{"template": "plotly_dark"}],
                # ),
                dict(
                    label="Colorblind Mode",
                    method="update",
                    args=[{"increasing": {"line": {"color": "blue"}},
                           "decreasing": {"line": {"color": "aqua"}}}],
                    args2=[{"increasing": {"line": {"color": "red"}},
    ...
    title=dict(
        text='<b>Cryptocurrencies  Dashboard<b>',
    ...
    annotations=[
        dict(
            text="<b>Choose Cryptocurrency: <b>",
