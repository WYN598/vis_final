...
fig = make_subplots(
    ...
    specs=[
        ...
        [{"rowspan": 1, "colspan": 1, "type": "domain"}, {"rowspan": 1, "colspan": 1, "type": "domain"},
         {"rowspan": 1, "colspan": 2}, None],  # 饼图和热力图行
    ],
...
fig.update_layout(
    ...
    updatemenus=[dict(type='dropdown',
                 ...
                 #
                 #             args3=[{"increasing": {"bar": {"color": "blue"}},
                 #                     "decreasing": {"bar": {"color": "aqua"}}}],
                 #             args4=[{"increasing": {"bar": {"color": "blue"}},
                 #                     "decreasing": {"bar": {"color": "aqua"}}}],
                 #         )
                 #     ],
                 #     pad={"r": 10, "t": 10},
